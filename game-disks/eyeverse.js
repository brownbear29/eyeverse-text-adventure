  ...
  rooms: [
    {
      ...
      desc:  `Welcome to the **King's Foyer**. 
    ...
    {
      id: 'reception',
      name: 'Eye Labs Reception Desk',
      desc: `**RONALD** is here. I'm sure he'd be happy to tell you more about the features available in **Eyeverse.world**.
      ...
      *You can speak with characters using the **TALK** command.*
      ...
      items: [
        ...
        {
          name: 'door',
          desc: `There are 4" metal letters nailed to the door. They spell out: "EYE LAB".`,
          onUse() {
    ...
    },
    {
      id: 'lab',
      name: 'Eye Lab',
      desc: `There is a **BLUE EYEPHUNK** hovering silently in the center of a white void. They appear to be awaiting instructions. (Type **TALK** to speak to the EyePhunk.)
  ...
  characters: [
    {
      ...
      topics: [
        ...
        },
        {
          ...
          "Sometimes an **exit** will be temporarily blocked. Try going **EAST** from here to see what I mean. You'll find the **DOOR** is locked. You'll need to find the **KEY** to get inside.
